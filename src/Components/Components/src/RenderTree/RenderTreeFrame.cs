...
#endif
{
    ...
    public struct RenderTreeFrame
    {
        ...
        private RenderTreeFrame(int sequence, int componentSubtreeLength, [DynamicallyAccessedMembers(Internal.LinkerFlags.Component)] Type componentType, ComponentState componentState, object componentKey)
            : this()
        {
            SequenceField = sequence;
        ...
        internal static RenderTreeFrame ChildComponent(int sequence, [DynamicallyAccessedMembers(Internal.LinkerFlags.Component)] Type componentType)
